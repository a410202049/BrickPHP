...
class DB extends Base {
    ...
    public function __construct() {
        ...
        $this->_host = Config::get('database.mysql.host');
        $this->_port = Config::get('database.mysql.port');
        $this->_user = Config::get('database.mysql.username');
        $this->_pass = Config::get('database.mysql.password');
        $this->_dbName = Config::get('database.mysql.dbname');
        //连接数据库
